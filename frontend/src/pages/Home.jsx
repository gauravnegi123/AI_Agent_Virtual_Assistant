...
function Home() {
  ...
  return (
    <div className='w-full h-[100vh] bg-gradient-to-t from-[#000000] to-[#08084e] flex flex-col justify-center items-center gap-[15px] overflow-x-hidden'>
      ...
      <div className={`absolute lg:hidden top-0 w-full h-full backdrop-blur-xl p-[20px] flex flex-col gap-[20px] items-start ${ham?"translate-x-0":"translate-x-full"} transition-transform `}>
