...
function Home() {
  ...
  const speak = (text) => {
    ...
    utterence.onend = () => {
      ...
      setTimeout(() => {
        startRecognition();             //Delay race condition avoide krne ke lie h
      },800);
    }
    synth.cancel(); //pele se koi speech ho to use bnd kr dega
  ...
  useEffect(() => {
    ...
    let isMounted = true;  //flag to avoide setState on Unmounted component
  ...
  return (
    <div className='w-full h-[100vh] bg-gradient-to-t from-[#000000] to-[#08084e] flex flex-col justify-center items-center gap-[15px] overflow-hidden overscroll-behavior:none'>

      <CgMenuRight className='lg:hidden text-white absolute top-[20px] right-[10px] w-[25px] h-[25px]' onClick={()=>setHam(true)}/>

      <div className={`lg:hidden absolute left-15 top-0 w-full h-full backdrop-blur-xl p-[20px] flex flex-col gap-[20px] items-start ${ham?"translate-x-0":"translate-x-full"} transition-transform ease-in-out`}>
        ...
        <button className='min-w-[100px] h-[50px] rounded-full text-white font-semibold text-[20px] px-[20px] py-[10px] cursor-pointer' onClick={handleLogout}>
          Log Out
        </button>
        ...
        <div className= 'w-full h-[2px] bg-gray-400'></div>
        <h1 className='text-white font-semibold text-[21px]'>Recents</h1>

        <div className='w-full h-[400px] gap-[15px] overflow-y-auto flex flex-col'>
      ...
      <div className='w-[300px] h-[400px] flex justify-center items-center overflow-hidden'>
        ...
        <button className='min-w-[100px] h-[50px] mt-[30px] bg-white rounded-full text-black font-semibold text-[20px] absolute top-[20px] right-[20px] px-[20px] py-[10px] cursor-pointer hidden lg:block' onClick={handleLogout}>
          Log Out
        </button>
